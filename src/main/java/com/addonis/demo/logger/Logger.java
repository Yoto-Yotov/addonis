package com.addonis.demo.logger;
...
public class Logger {
    ...
    private Logger(String fileName, Class caller) {
    ...
    private void setProperties(String fileName) {
        ...
        try {
            FileHandler fh = new FileHandler(USER_DIR + File.separator + "logs" + File.separator + fileName);
    ...
    public static synchronized Logger getLogger() {
        ...
        if (instance == null) {
            instance = new Logger("app_logger", Logger.class);
        }
